...
export default function HomePage() {
  ...
  React.useEffect(() => {
    ...
    featuredApi.on("select", () => setFeaturedCurrent(featuredApi.selectedScrollSnap() % featuredProducts.length));
  }, [featuredApi, featuredProducts.length]);

  React.useEffect(() => {
    if (!popularApi) return;
    setPopularCurrent(popularApi.selectedScrollSnap() % popularProducts.length);
    popularApi.on("select", () => setPopularCurrent(popularApi.selectedScrollSnap() % popularProducts.length));
  }, [popularApi, popularProducts.length]);
