...
export const Icons = {
  logo: (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor" {...props}>
      <path d="M51.6,3.2H12.4C9.2,3.2,6.4,5.9,6.4,9.2v45.6c0,3.3,2.7,6,6,6h39.2c3.3,0,6-2.7,6-6V9.2C57.6,5.9,54.9,3.2,51.6,3.2z M54.4,54.8c0,1.5-1.2,2.8-2.8,2.8H12.4c-1.5,0-2.8-1.2-2.8-2.8V9.2c0-1.5,1.2-2.8,2.8-2.8h39.2c1.5,0,2.8,1.2,2.8,2.8V54.8z"/>
      <path d="M41.4,14.6c-5.8,0-10.4,4.7-10.4,10.4c0,4.3,2.6,8,6.4,9.6c-6.2,3.3-10.5,9.8-10.5,17.2h3.3c0-8.8,6.4-16.1,14.5-16.1c3.8,0,7.3,1.5,9.9,4.1c-1.3-1.8-3.2-3.2-5.4-3.9c6.1-3,10.1-9.2,10.1-16.4C51.8,19.3,47.2,14.6,41.4,14.6z M41.4,32.2c-3.9,0-7.2-3.2-7.2-7.2s3.2-7.2,7.2-7.2s7.2,3.2,7.2,7.2S45.3,32.2,41.4,32.2z"/>
      <path d="M21.1,49.4c5.8,0,10.4-4.7,10.4-10.4c0-4.3-2.6-8-6.4-9.6c6.2-3.3,10.5-9.8,10.5-17.2h-3.3c0,8.8-6.4,16.1-14.5,16.1c-3.8,0-7.3-1.5-9.9-4.1c1.3,1.8,3.2,3.2,5.4,3.9c-6.1,3-10.1,9.2-10.1,16.4C10.7,44.7,15.3,49.4,21.1,49.4z M21.1,32.2c3.9,0,7.2-3.2,7.2-7.2s-3.2-7.2-7.2-7.2s-7.2,3.2-7.2,7.2S17.2,32.2,21.1,32.2z"/>
    </svg>
  ),
  ...
  apparel: (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m21.42 6.6-8.24 8.24-2.34-2.34-5.36 5.36" />
      <path d="M12.76 6.6H21" />
      <path d="M21 15.24V7" />
      <path d="m5.28 12.8-2.34 2.34-1.48-1.48" />
      <path d="M3.5 21.5V13" />
      <path d="M9.76 12.8h.01" />
      <path d="M15.28 18.32h.01" />
    </svg>
  ),
  ...
  americanFootball: (props: SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 2C6.5 2 2 7.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2z"/>
      <path d="M12 12l6-4"/>
      <path d="M6 8l6 4"/>
      <path d="M12 2v20"/>
    </svg>
